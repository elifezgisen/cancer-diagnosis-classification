...
BreastNumber = cm2[0, 0] + cm2[0, 1] + cm2[0, 2] + cm2[0, 3]
ColonNumber = cm2[1, 0] + cm2[1, 1] + cm2[1, 2] + cm2[1, 3]
LungNumber = cm2[2, 0] + cm2[2, 1] + cm2[2, 2] + cm2[2, 3]
ProstateNumber = cm2[3, 0] + cm2[3, 1] + cm2[3, 2] + cm2[3, 3]

# Breast Cancer
print('Breast Cancer:')
print('-------------------')

BreastSensitivity = cm2[0, 0] / BreastNumber
print('BreastSensitivity : ', BreastSensitivity)

BreastSpecificity = (cm2[1, 1] + cm2[2, 2] + cm2[3, 3]) / (ColonNumber + LungNumber + ProstateNumber)
...
ColonSensitivity = cm2[1,1] / ColonNumber
print('ColonSensitivity : ', ColonSensitivity)

ColonSpecificity = (cm2[0, 0] + cm2[2, 2] + cm2[3, 3]) / (BreastNumber + LungNumber + ProstateNumber)
...
LungSensitivity = cm2[2,2] / LungNumber
print('LungSensitivity : ', LungSensitivity)

LungSpecificity = (cm2[0, 0] + cm2[1,1] + cm2[3, 3]) / (BreastNumber + ColonNumber + ProstateNumber)
...
ProstateSensitivity = cm2[3,3] / ProstateNumber
print('ProstateSensitivity : ', ProstateSensitivity)

ProstateSpecificity = (cm2[0, 0] + cm2[1,1] + cm2[2,2]) / (BreastNumber + ColonNumber +LungNumber)
